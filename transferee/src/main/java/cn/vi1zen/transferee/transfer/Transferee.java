...
import cn.vi1zen.transferee.utils.AppManager;
import cn.vi1zen.transferee.utils.FileUtils;
import cn.vi1zen.transferee.view.video.ExoVideoView;
import cn.vi1zen.transferee.view.video.source.ExoSourceManager;
...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private void checkConfig() {
        ...
        if (transConfig.isSourceEmpty())
            throw new IllegalArgumentException("The parameter sourceModelList or sourceUriList can't be empty");
    ...
    public File getImageFile(String imageUrl) {
        return transConfig.getCache(imageUrl);
    }
