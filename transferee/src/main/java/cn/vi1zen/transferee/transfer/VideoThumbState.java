...
import cn.vi1zen.transferee.utils.EncryptUtils;
import cn.vi1zen.transferee.utils.FileUtils;
import cn.vi1zen.transferee.view.image.TransferImage;
import cn.vi1zen.transferee.view.video.ExoVideoView;
...
public class VideoThumbState extends TransferState {
    ...
    public TransferImage transferIn(int position) {
        ...
        String videoSourceUrl = (String) transConfig.getSourceModelList().get(position);
    ...
    public void transferLoad(final int position) {
        ...
        final String videoSourceUrl = (String) transConfig.getSourceModelList().get(position);
        ...
        exoVideo.setSource((String) transConfig.getSourceModelList().get(position), false);
    }
